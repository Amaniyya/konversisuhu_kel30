            ...
            if ((suhu != null) && (suhu.length() > 0)) {
                ...
                if (request.getParameter("Fahrenheit Ke Reamur") != null) {
                 ...
                 if (request.getParameter("Celcius Ke Kelvin") != null) {
                    String kelv = konversisuhu.celcius_Kelvin(d); 
                    out.println("<p> HASIL KONVERSI SUHU: "+kelv+ " .</p>");
                }
                ...
                out.println("<br/>");
                out.println("<br/>");
                out.println("<input type=\"submit\" name=\"Celcius Ke Kelvin\" value=\"Celcius Ke Kelvin\">");
